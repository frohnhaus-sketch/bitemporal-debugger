...
const DECOMPOSED_TARGET_TABLE = `entity_id,valid_from,valid_to,visible_from,visible_to,risk_code,coverage_code,decomposition_status
...
const WRONG_TARGET_TABLE = `entity_id,valid_from,valid_to,visible_from,visible_to,risk_code,coverage_code,decomposition_status
    ...
    <section style={darkCardStyle}>
      ...
      <div style={exampleNoteStyle}>
        ...
        <p style={exampleNoteTextStyle}>
          ...
          splits only at real source boundaries and resolves the active
          attribute combination per atomic rectangle. After decomposition,
          neighbouring rectangles can be compacted along valid time when the
          resolved attribute combination stays identical.
        </p>
      </div>
    </section>
  );
  ...
  return (
    <section style={testCaseCardStyle}>
      ...
      <div style={testCaseGridStyle}>
        <CopyTableCard
          title="Decomposed target table"
          description="Copy this table to validate the expected decomposed reporting intervals."
          tableName="decomposed_target"
          value={DECOMPOSED_TARGET_TABLE}
          tone="good"
        ...
        <CopyTableCard
          ...
          description="Copy this table to validate an output where overlapping intervals were not decomposed."
      ...
      <button
        ...
        onClick={() => {
          ...
          track("example_model_cta_clicked", {
            example: "rectangle_decomposition",
  ...
  return (
    <g>
      <rect
        ...
        height={height}
        fill={
          highlight ? "rgba(14, 165, 233, 0.28)" : "rgba(148, 163, 184, 0.35)"
        }
